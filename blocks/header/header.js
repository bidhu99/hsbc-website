  ...
  rightData.forEach((item) => {
    if (item.name) {
      ...
      if (item?.name === "Register") {
        ...
        anchor.className = "A-LNKB-RW-ALL";

        const spanText = document.createElement("span");
        spanText.className = "link one-word";

        spanText.innerHTML = item.name;

        const registerIconSpan = document.createElement("span");
        registerIconSpan.className =
          "icon icon-chevron-right-small icon-chevron-down-small";
        registerIconSpan.setAttribute("aria-hidden", "true");

        li.innerHTML = "";
        li.className = "header-dropdown header-user-wrapper register-button";
        anchor.appendChild(spanText);
        anchor.appendChild(registerIconSpan);
...
function buildMobileHeader(headerData, leftData) {
  ...
  buttonTextSpan.className = "header-sidebar-trigger-text";
  buttonTextSpan.textContent = "Menu";
  buttonContainer.appendChild(buttonTextSpan);
  ...
  headerData.sections.forEach((section, sectionIndex) => {
    ...
    individualIconDesktopSpan.className =
      "icon icon-chevron-right hide-on-desktop";
    individualIconDesktopSpan.setAttribute("aria-hidden", "true");
    triggerDiv.appendChild(individualIconDesktopSpan);
  ...
  singleRedirectionContainer.className =
    "header-mobile-sidebar-footer header-dropdown";
  ...
  leftData.forEach((businessLink, businessIndex) => {
    ...
    businessLinkAnchor.className =
      "header-mobile-business-item register-button";
    ...
    iconSpanContainer.className =
      "icon icon-chevron-right icon-chevron-down-small";
