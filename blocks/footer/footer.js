...
export default async function decorate(block) {
  ...
  if (
    customerSupportContainer == null &&
    primaryFooterContainer == null &&
    secondaryFooterContainer == null
  ) {
...
function customerSupport() {
  ...
  if (supportData != null) {
    document
      .querySelectorAll(".socialMediaFooter.grid")
    ...
    container.innerHTML = `
    <div class="row">
        <div class="sm-12 social-row" id="content_socialmediafooter_1">
          <span class="A-DIVHL-RW-ALL"></span>

          <div class="sm-12 lg-9">
            <div id="content_link_6" class="link-container">
              <a class="A-LNKC22L-RW-ALL" href="${
                supportData.helpLink
              }" rel="nofollow" data-event-component="text link" data-event-name="Customer support">
          ...
          <ul class="footer-large">
            ${footerJSON
              ...
              <li class="footer-large-item lg-3">
                ...
                <a href="${
                  item.url
                }" data-event-component="footer" data-event-name="${
                  item.description
                }">
      ...
      <div class="row wrapper">
        <nav class="lg-7" aria-label="Footer navigation">
          <ul class="footer-supplementary clearfix">
            ${footerBottomJSON.supplementaryLinks
              .map(
                (link) => `
        ...
        <div class="footer-legal-regulatory sm-12 lg-5 text">
          <p>
            <a href="${
              footerBottomJSON.groupInfo.url
            }" target="_blank" rel="noopener">
              <span aria-hidden="true">${
                footerBottomJSON.groupInfo.title
              }</span>
          ...
          <p>
            <a href="${footerBottomJSON.countryNotice.url}">${
    footerBottomJSON.countryNotice.text
  }</a>
          </p>
        </div>
      </div>
